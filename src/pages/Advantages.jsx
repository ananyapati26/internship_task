...
const Advantages = () => {
  return (
    ...
    <div  className=' lg:w-[70%] flex flex-col w-[100%] justify-center items-center lg:flex lg:flex-row lg:justify-center lg:items-center'>
        <div className='lg:w-[50%] flex flex-col justify-center pl-20 pr-20 xl:pr-0'>
        ...
        <div className='w-[80%] lg:w-[50%] '><img src={frame4} alt='ok'/></div>
    </div>
    ...
    <div className='lg:w-[50%] flex flex-col justify-center pl-20 pr-20 lg:pr-20 lg:pl-0'>
    ...
    <div className='w-[80%] lg:w-[50%]'><img src={frame8} alt='ok'/></div>
</div>
</>
  )
}
